...
Runtime commit `9b0abf2cc712d367f36659c74a93526a9f24c0de` was deployed to [the public edition](https://offline-vastness.vercel.app). Vercel reported deployment `dpl_5m8UPSTNMwaSuX6ZDQjpKwA8VK4m` READY, and GitHub build/unit CI passed. The public walking route passed all 23 checks in installed Chrome 152.0.7977.82. Its High/DPR1 1600×1000 shoreline sample recorded a 7.0 ms frame-interval p95 and a 4.981 ms GPU-render-pass p95 over 180 samples. These are short observations on one desktop, not a 60 FPS guarantee on other devices.

Public shoreline and GR screenshots were opened and visually reviewed. The subsequent wider public regression process was interrupted and its final result was not retained; it is not reported as a completed pass. The retained reports and deployment metadata are in `evidence/vastness-2.3/`. Before the 3.0 work began, the actual 2.3 public opening was opened again in installed Chrome and its water, reflections, forest, waterfall and free-flight entry were visually inspected.
